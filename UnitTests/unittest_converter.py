...
class converterTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.get_version_response = [0x37, 0x00, 0x15, 0x25, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x0b, 0x56, 0x53, 0x41, 0x20, 0x32, 0x2e, 0x30, 0x2e, 0x30, 0x2e, 0x37]
        self.short = 3700
        self.ushort = 30000
        self.int = 2000000
    ...
    def test_byte_converter_to_uint_32_return_valid(self):
        ...
        :return:
        """
        self.assertEqual(0x61200030, converters.to_uint_32(self.case32, 0))   #[0x61, 0x20, 0x00, 0x30, 0x23] -> 0x61200030
        self.assertEqual(0x20003023, converters.to_uint_32(self.case32, 1)) #[0x61, 0x20, 0x00, 0x30, 0x23] ->0x20003023
        # self.assertRaises(Main.to_u_int_16_ex(self.case1, 4),
        with self.assertRaises(IndexError) as context:
